...
var incompleteTaskHolder = document.querySelector(".current__list"); //ul of #incompleteTasks
...
var taskCompleted = function () {
  ...
  var listItem = this.parentNode;
  listItem.children[1].classList.add("task__label_completed");
...
var taskIncomplete = function () {
  ...
  var listItem = this.parentNode;
  listItem.children[1].classList.remove("task__label_completed");
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
};
